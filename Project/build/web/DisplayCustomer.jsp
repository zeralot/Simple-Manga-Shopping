        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                    ...
                    %>
                    <h2 align="center"> Customer Manager </h2>
                    <div class="row col-md-12 col-md-offset-0 custyle">
                        <table  class="table table-striped custab">
                            ...
                            <tr>
                                ...
                                <td><%=(rs.getInt(8) == 1 ? "Active" : "Deactive")%></td>
                                <td class="text-center"><a class='btn btn-info btn-xs' href="CusController?id=<%=rs.getInt(1)%>&service=preUpdate"><span class="glyphicon glyphicon-edit"></span>Edit</a>
                                    <a href="CusController?id=<%=rs.getInt(1)%>&service=delete" 
