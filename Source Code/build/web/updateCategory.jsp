        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                    ...
                    %>
                    <form action="CatController" method="POST" class="form-horizontal">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input name="cname" type="text" value="<%=cat.getCname()%>" class="form-control input-md" required="">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="radio" name="status" value="1" <%= cat.getStatus() == 1 ? "checked" : ""%> /> Enable
                                    <input type="radio" name="status" value="0" <%= cat.getStatus() == 0 ? "checked" : ""%> /> Disable
                            ...
                            <input type="hidden" name="ctid" value="<%=cat.getCtid()%>"  />
                        </fieldset>
                    </form>
                </div>
            </div>
