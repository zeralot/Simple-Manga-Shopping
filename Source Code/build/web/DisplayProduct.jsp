        ...
        <h2 align="center">Product Manager</h2>
           <div class="row col-md-12 col-md-offset-0 custyle">
            ...
            <tr>
                ...
                <td><img src="<%=rs.getString(5)%>" width="152" height="152"/></td>
                <td><%=rs.getString(6)%></td>
                <td><%=rs.getString(8)%></td>
                <td><%=(rs.getInt(7) == 1 ? "Active" : "Deactive")%></td>
                <td class="text-center"><a class='btn btn-info btn-xs' href="ProController?id=<%=rs.getString(1)%>&service=preUpdate"><span class="glyphicon glyphicon-edit"></span>Edit</a>
                                    <a href="ProController?id=<%=rs.getString(1)%>&service=delete" 
